...
function Search() {
  ...
  return (
    <div>
      ...
      <div class="px-4 mt-4">
        <div class="bg-white text-black rounded-lg px-3 py-2 flex items-center space-x-2">
          <svg
      ...
      {data.length === 0 && (
        <div class="px-4 mt-6 space-y-4">
          <h2 class="font-bold text-lg">Start browsing</h2>
          <div class="grid grid-cols-2 gap-4">
            <div class="bg-pink-600 h-20 rounded-xl flex items-center justify-center text-white font-semibold">
              Music
            </div>
            <div class="bg-green-800 h-20 rounded-xl flex items-center justify-center text-white font-semibold">
              Podcasts
            </div>
            <div class="bg-purple-600 h-20 rounded-xl flex items-center justify-center text-white font-semibold">
              Live Events
            </div>
            <div class="bg-blue-800 h-20 rounded-xl flex items-center justify-center text-white font-semibold">
              Home of I-Pop
            </div>
          </div>

          <div class="px-4 mb-4">
            <h2 class="text-xl font-semibold mb-2">Discover something new</h2>
            <div class="grid grid-cols-3 gap-3">
              <div class="h-32 rounded-xl overflow-hidden relative">
                ...
                />
                <div class="absolute bottom-2 left-2 text-white font-semibold text-sm">
                  #haryanvi
                  <br />
                  pop
                </div>
