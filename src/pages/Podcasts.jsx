  ...
  return (
    <>
      ...
      <div class="px-4 py-6 space-y-4">
        <div class="bg-[#083b3f] p-4 rounded-xl space-y-4">
          <div class="flex items-start justify-between">
            <div>
              <h2 class="text-lg font-bold">Daily Affirmations</h2>
              <p class="text-gray-400 text-sm">Episode • It's Different</p>
            </div>
          ...
          <div class="flex flex-col items-center space-y-4">
            ...
            <p class="text-sm text-gray-300 text-center">
              <span class="font-semibold text-white">Mar 19 • 21 min •</span>
